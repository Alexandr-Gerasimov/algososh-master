  ...
  return (
    <SolutionLayout title="Сортировка массива">
      <div className={styles.head}>
        <RadioInput label="Выбор" onChange={() => setRadioType("change")} checked={radioType === "change"}></RadioInput>
        <RadioInput label="Пузырёк" onChange={() => setRadioType("bubble")} checked={radioType === "bubble"}></RadioInput>
        <Button text="По возрастанию" onClick={() => radioType === "bubble" ? bubbleSort(newArr, "acending") : changeSort(newArr, "acending")}></Button>
        <Button text="По убыванию" onClick={() => radioType === "bubble" ? bubbleSort(newArr, "decending") : changeSort(newArr, "decending")}></Button>
